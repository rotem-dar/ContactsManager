...
public class EditContactsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // takes all the texts and photo from the intent extra and sets them in the corresponding places
        ...
        if (getIntent().getStringExtra("picture") != null) {
            contactImage.setPadding(0, 0, 0, 0); // remove padding
            contactImage.setImageURI(Uri.parse(getIntent().getStringExtra("picture")));
        } else {
            contactImage.setPadding(20,20,20,20); // adds padding
        ...
        new Thread() {
            ...
            public void run() {
                ...
                contact = AppDatabase.getInstance(EditContactsActivity.this).contactDao().getContact(contactId);
            }
        }.start();
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nameStr.equals("")) {
                    Toast.makeText(EditContactsActivity.this, "Name cannot be empty", Toast.LENGTH_SHORT).show();
                } else if (phoneNumberStr.equals("")) {
                    Toast.makeText(EditContactsActivity.this, "Number cannot be empty", Toast.LENGTH_SHORT).show();
                } else {
                    // sets the new values to the contact
                    contact.setName(nameStr);
                    contact.setPhoneNumber(phoneNumberStr);
                    contact.setPicture(contactImageStr);
                    contact.setEmailAdr(emailAdrStr);
                    contact.setHomeAdr(homeAdrStr);
                    contact.setWebsiteAdr(websiteAdrStr);
                    contact.setBirthDate(birthDateStr);
                    contact.setCallTime(callTimeStr);
                    contact.setCallDays(callDayStr);
                    ...
                    new Thread() {
                        ...
                        public void run() {
                            ...
                            // updates the contact
                            AppDatabase.getInstance(EditContactsActivity.this).contactDao().updateContact(contact);
                        }
                    }.start();
        ...
        birthDateBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(EditContactsActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        callTimeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TimePickerDialog timePickerDialog = new TimePickerDialog(EditContactsActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
